...
const I18N = {
            ...
            items: [
                {
                    ...
                    a: `<p>NOVA analyzes market data and keeps only setups that pass risk and entry-quality filters.</p>`,
                },
                {
    ...
    ru: {
        ...
        faq: {
            title: "FAQ",
            items: [
                { q: "Как бот генерирует сигналы?", a: `<p>NOVA анализирует рынок и оставляет только те сетапы, которые прошли фильтры по риску и качеству входа.</p>` },
